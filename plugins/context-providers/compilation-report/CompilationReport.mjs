...
export const hasNodeBuild = () => compilationReportContext.getStore().get(hasNodeBuildSymbol);
export const hasBrowserBuild = () => compilationReportContext.getStore().get(hasBrowserBuildSymbol);
