...
export const getAppDirBuilder = () =>
	pathsContext.getStore().get(appDirBuilderSymbol);
...
export const getAppPackageJson = () =>
	pathsContext.getStore().get(appPackageJsonSymbol);

export const tsTestsSetupSymbol = Symbol("tsTestsSetupSymbol");
export const getTsTestsSetup = () =>
	pathsContext.getStore().get(tsTestsSetupSymbol);

export const jsTestsSetupSymbol = Symbol("jsTestsSetupSymbol");
export const getJsTestsSetup = () =>
	pathsContext.getStore().get(jsTestsSetupSymbol);

export const appBabelRcSymbol = Symbol("appBabelRcSymbol");
export const getAppBabelRc = () =>
	pathsContext.getStore().get(appBabelRcSymbol);

export const appJsConfigSymbol = Symbol("appJsConfigSymbol");
export const getAppJsConfig = () =>
	pathsContext.getStore().get(appJsConfigSymbol);

export const appTsConfigSymbol = Symbol("appTsConfigSymbol");
export const getAppTsConfig = () =>
	pathsContext.getStore().get(appTsConfigSymbol);

/** the path to the root of this config builder */
export const configBuilderDirSymbol = Symbol("configBuilderDirSymbol");
export const getConfigBuilderDir = () =>
	pathsContext.getStore().get(configBuilderDirSymbol);
