...
export const browserDevServerConfigSymbol = Symbol(
	"browserDevServerConfigSymbol",
);
export const browserDevServerHeadersSymbol = Symbol(
	"browserDevServerHeadersSymbol",
);
export const browserDevServerClientOverlaySymbol = Symbol(
	"browserDevServerClientOverlaySymbol",
);
export const browserDevServerClientProgressSymbol = Symbol(
	"browserDevServerClientProgressSymbol",
);
export const browserDevServerWatchSymbol = Symbol(
	"browserDevServerWatchSymbol",
);

export const attachHmrClientSymbol = Symbol("attachHmrClientSymbol");
export const attachHmrClientWatchIgnoreSymbol = Symbol(
	"attachHmrClientWatchIgnoreSymbol",
);
export const attachHmrClientWatchOptionsSymbol = Symbol(
	"attachHmrClientWatchOptionsSymbol",
);

export const browserDevServerConfig = () =>
	getHook(browserDevServerConfigSymbol, {
		compress: true,
		...
		async (config) => {
			...
			return {
				...
				entry: {
					...
					client: [
						getConfigBuilderDir() +
							"/plugins/webpack/hmr/webpackHotDevClientV4.cjs",
						...config.entry.client,
					],
				},
