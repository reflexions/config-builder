...
import { getAppSrc } from "../../context-providers/paths/Paths.mjs";
...
export const postcssCustomMediaEnabledHook = Symbol(
	"postcssCustomMediaEnabledHook",
);
										...
										options: {
											postcssOptions: {
												...
												plugins: [
													...
													...(tailwindEnabled
														? await getHookFnResult(tailwindHook, async () => [
																...
																tailwind(
																	(
																		await import(
																			(process.env.FRONTEND_BUILD_ROOT ||
																				"/var/www/html") +
																				"/tailwind.config.mjs"
																		)
																	).default,
													...
													(isProduction || old_browser_compat) &&
														!isNode &&
														autoprefixer({
															// https://github.com/postcss/autoprefixer#options
															overrideBrowserslist: await getHookFnResult(
																getTargetsHook,
																undefined,
																[isNode],
															),
